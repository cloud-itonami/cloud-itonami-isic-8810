# Operator Quickstart — Community Care Coordination

Shortest path from clone to a verified local dry-run for **ISIC 8810** (`cloud-itonami-isic-8810`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8810.git
cd cloud-itonami-isic-8810
```
...
- Blueprint governor key: `safeguarding-governor`
- Likely source path: `care.governor.cljc`
